...
$$p(Y_{AB}) = \frac{exp^{`r glmcoe[1]` + (`r glmcoe[2]`X_{AB1}) + (`r glmcoe[3]`X_{AB2}) + (`r glmcoe[4]`X_{AB3}) + (`r glmcoe[5]`X_{AB4}) + (`r glmcoe[6]`X_{AB5})}}{1 + exp^{`r glmcoe[1]` + (`r glmcoe[2]`X_{AB1}) + (`r glmcoe[3]`X_{AB2}) + (`r glmcoe[4]`X_{AB3}) + (`r glmcoe[5]`X_{AB4}) + (`r glmcoe[6]`X_{AB5})}}$$
...
We simulate the match results and predict playoff teams for 1000 times, using the ridge regression model above. Given table A and table B data, we could write our simulation process algorithm as below:
...
2, DEN’s main power forward Millsap rejoin the team in the mid-season and not perform well during the first several months after he rejoins.
3, LAC traded its main power forward Griffin in the mid-season, gave up their fighting for the playoff and started the team’s rebuilt.
4, The 4th to 10th teams in the West are very competitive with each other. Their win rates are only 2% different at most.
